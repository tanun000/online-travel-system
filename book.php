...
$name=$b['name'];
$id=$_POST['pack'];
$p=mysqli_query($al, "SELECT * FROM payment WHERE id='$id'");
...
if($id!=NULL && $j!=NULL && $m!=NULL && $d!=NULL)
{
	...
	if($sql)
	{
		$info="Successfully Received Your Booking Info.<br> Total Amount Payable for $m Member(s) is BDT $amount";
	}
	else
	{
...
<title>Online Travels System</title>
...
<br />
<br />
<div align="center"> <span class="subHead">Book Package</span> <br />
  <br />
