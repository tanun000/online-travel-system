...
if($n!=NULL && $am!=NULL)
{
	$sql=mysqli_query($al, "INSERT INTO payment(name,amount) VALUES('$n','$am')");
	if($sql)
	{
...
<br />
<br />
<div align="center"> <span class="subHead">Manage Packages<br />
<br /> 
<form method="post" action="">
<table border="0" cellpadding="2" cellspacing="2" class="design">
<tr><td align="center" class="info"><?php echo $info;?></td></tr>
<tr><td><input type="text" name="name" placeholder="Enter payment Package Name" size="40" class="fields" required="required"  autocomplete="off" /></td></tr>
...
<?php
$u=1;
$x=mysqli_query($al, "SELECT * FROM payment");
